...
export const THEME_COMFORTAA = {
    id: "COMFORTAA",
    overrideTheme: function (settings) {
        const fontComfortaa = `"comfortaa", "Roboto", "Helvetica", "Arial", sans-serif`;
        const fontOpenSans = `"open-sans", "Roboto", "Helvetica", "Arial", sans-serif`;
        const primaryColor = '#1684a6';
//        const buttonHeight = 49;
        const borderRadius = 8;
        const toolbarTextColor = 'rgba(0, 0, 0, 0.64);';
        settings.palette.primary.main = primaryColor;
        settings.palette.primary.light = primaryColor;
        settings.palette.primary.dark = primaryColor;
        settings.palette.secondary.main = primaryColor;
        settings.palette.secondary.light = primaryColor;
        settings.palette.secondary.dark = primaryColor;
        settings.typography = {
            'h1': {
...
export const ALL_THEMES = [
    THEME_STANDARD, THEME_COMFORTAA
];
